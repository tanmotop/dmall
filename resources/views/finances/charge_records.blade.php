                        ...
                        $.each( json.data, function ( k, v ){
                            ...
                            if( k < singleNumber ){
                                html += '<div class="zc-bottom">' +
                                    '<ul>' +
                                    '<li>充值单号：<input readonly style="width: 55%" type="text" value="' + v.sn + ' |">' + '<span style="color: green;">已到账</span>' + '</li>' +
                                    '<li>充值金额：<input readonly type="text" value="￥' + v.money + '"></li>' +
                                    '<li>充值时间：<input readonly type="text" value="' + v.created_at + '"></li>' +
                                    '<li>充值形式：<input style="color: orange" readonly type="text" value="管理员充值"></li>' +
                                    '<li>充值前余额：<input readonly type="text" value="￥' + v.money_pre + '"></li>' +
                                    '<li>充值后余额：<input readonly type="text" value="￥' + v.money_after + '"></li>' +
                                    '</ul>' +
                                    '</div>';
                                eachNumber++;
                            }
